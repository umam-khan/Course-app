...
// Connect to MongoDB
try{mongoose.connect('mongodb+srv://umamkhan:nP2oomDs61COw0tj@cluster0.6umualh.mongodb.net/courses', { useNewUrlParser: true, useUnifiedTopology: true, dbName: "courses" });
}
catch(err){
    console.log(err);
}
